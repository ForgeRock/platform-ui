...
describe('Navbar Component', () => {
  ...
  it('Includes additional content slot if provided', () => {
    const wrapper = shallowMount(PageHeader, {
      props: {},
      slots: {
        additionalContent: '<template #additionalContent><p>SlotTest</p></template>',
      },
    });
    expect(wrapper.find('p').text()).toContain('SlotTest');
  });
});
