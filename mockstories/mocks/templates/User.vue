        ...
        <template>
            <div class="mb-4 media">
                ...
                <div class="media-body align-self-center">
                    <h1 class="mb-1">Barbara Jensen</h1>
                    <p>bjensen</p>
                    <div class="d-flex" v-if="!readonly">
                        <div class="mr-2 dropdown">
                            <button aria-haspopup="true" aria-expanded="false" id="dropdown-basic" type="button" class="dropdown-toggle btn btn-outline-secondary"><i class="material-icons-outlined mr-md-3 align-bottom">lock_open</i><span class="d-none d-md-inline">Active</span></button>
                        </div>
                        <button icon="cached" type="button" class="text-nowrap btn btn-outline-secondary"><i class="material-icons-outlined mr-md-3 align-bottom text-nowrap">cached</i><span class="d-none d-md-inline">Reset Password</span></button>
                    </div>
                </div>
            </div>
            <form>
                <div class="card" v-if="readonly">
                    <div class="card-body">
                        <dl>
                            <dt><small>First Name</small></dt>
                            <dd>Barbara</dd>
                            <dt><small>Last Name</small></dt>
                            <dd>Jensen</dd>
                            <dt><small>Email Address</small></dt>
                            <dd>bjensen@example.com</dd>
                            <dt><small>Street Address</small></dt>
                            <dd>1234 Mildchild Ln</dd>
                            <dt><small>City</small></dt>
                            <dd>Oakland</dd>
                            <dt><small>Postal Code</small></dt>
                            <dd>94501</dd>
                            <dt><small>Country</small></dt>
                            <dd>United States</dd>
                            <dt><small>State/Region</small></dt>
                            <dd>California</dd>
                            <dt><small>Phone Number</small></dt>
                            <dd>(415) 555-1212</dd>
                        </dl>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                          <div class="form-label-group mb-0">
                            <input
                              ...
                              value="California"
                            />
                            <label for="postalcodeInput">State/Region</label>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="form-label-group mb-0">
                            <input
                              ...
                              value="(415) 555-1212"
                            />
                            <label for="postalcodeInput">Phone Number</label>
                          </div>
                        </div>
                    </div>
                </div>
