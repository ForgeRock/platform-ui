...
echo "Setting ENABLE AIC CONNECTION UIS as $ENABLE_AIC_CONNECTION_UIS"
...
echo "Setting HELIX ANALYTICS AGENT VERSION as $HELIX_ANALYTICS_AGENT_VERSION"
echo "Setting HELIX ANALYTICS ENVIRONMENT ID as $HELIX_ANALYTICS_ENVIRONMENT_ID"
...
do
  ...
  envsubst '
    ...
    $ENABLE_MTLS
    $ENABLE_AIC_CONNECTION_UIS
    $ENABLE_NEW_MULTISELECT
    ...
    $GOOGLE_MAPS_API_KEY
    $HELIX_ANALYTICS_AGENT_VERSION
    $HELIX_ANALYTICS_ENVIRONMENT_ID
