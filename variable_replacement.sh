...
echo "Setting ENABLE ADMIN FEDERATION as $ENABLE_ADMIN_FEDERATION"
echo "Setting ENABLE_ADMIN_FEDERATION_GROUPS_CLAIM as $ENABLE_ADMIN_FEDERATION_GROUPS_CLAIM"
echo "Setting ENABLE ANALYTICS DASH as $ENABLE_ANALYTICS_DASH"
echo "Setting ENABLE GOVERNANCE as $ENABLE_GOVERNANCE"
echo "Setting ENABLE GOVERNANCE VERSION 2 as $ENABLE_GOVERNANCE_V2"
