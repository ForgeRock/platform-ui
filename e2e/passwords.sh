...
export CYPRESS_IDM_USERNAME="amadmin"
...
export CYPRESS_IDM_PASSWORD=$(kubectl --namespace $kubernetes_namespace get secret idm-env-secrets -o jsonpath='{.data.OPENIDM_ADMIN_PASSWORD}' | base64 --d)
